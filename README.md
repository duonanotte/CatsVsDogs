# 🤖 Guid for launching [CatsVsDogs](https://t.me/Tomarket_ai_bot/app?startapp=00001N6y) bot

![img1](./images/catsdogs.png)
...
| Auto Youtube task execution                              | <div align="center"> ☑️ </div> |
| Auto task execution                                      | <div align="center"> ☑️ </div> |
...
| **REF_ID**                  | <small>Your referral link in the format `6434058521`</small>                          |
...
| **CLAIM_REWARD**            | <small>`True` or `False` (default False)</small>                                       |
| **AUTO_TASK**               | <small>`True` or `False` (default False)</small>                                        |
...
## Step 1: Preparation
   ...
   * Download and extract the archive or use the command
     ...
     ```
     git clone https://github.com/duonanotte/CatsVsDogs.git
     ```
